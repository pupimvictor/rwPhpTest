...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $server['REQUEST_URI'] = '/index_old.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/index_old.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/index_old.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/index_old.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/index_old.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/index_old.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/index_old.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide index_old.php)
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/index_old.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/index_old.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/index_old.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/index_old.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/index_old.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/index_old.php';
        $server['ORIG_SCRIPT_NAME'] = '/index_old.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/index_old.php',
                    'SCRIPT_NAME' => '/fruit/index_old.php',
                    'PHP_SELF' => '/fruit/index_old.php',
                ),
                '/fruit',
            ...
            array(
                '/fruit/strawberry/1234index.php/blah',
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/index_old.php',
                    'SCRIPT_NAME' => '/index_old.php',
                    'PHP_SELF' => '/index_old.php',
                ),
                '',
                '/fruit/strawberry/1234index.php/blah',
            ),
