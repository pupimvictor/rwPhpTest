...
class Request
{
     ...
     *
     * Suppose that an index_old.php file instantiates this request object:
     *
     *  * http://localhost/index_old.php         returns an empty string
     *  * http://localhost/index_old.php/page    returns an empty string
     *  * http://localhost/web/index_old.php     returns '/web'
     *  * http://localhost/we%20b/index_old.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
     ...
     * script filename (e.g. index_old.php) if one exists.
     *
